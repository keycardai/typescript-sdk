...
export { fetchAuthorizationServerMetadata, fetchProtectedResourceMetadata } from "./discovery.js";
export type { OAuthAuthorizationServerMetadata, OAuthProtectedResourceMetadata } from "./discovery.js";
